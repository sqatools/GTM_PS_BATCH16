...
class BaseAPI:
    ...
    def post_method(self, url, header=None, request_body=None):
        header = header if header else {}
        request_body = request_body if request_body else {}
        response = request.request("POST", url, headers=headers, data=request_body)
    ...
    def put_method(self, url, header=None, request_body=None):
        header = header if header else {}
        request_body = request_body if request_body else {}
        response = request.request("PUT", url, headers=headers, data=request_body)
    ...
    def patch_method(self, url, header=None, request_body=None):
        header = header if header else {}
        request_body = request_body if request_body else {}
        response = request.request("PATCH", url, headers=headers, data=request_body)
    ...
    def delete_method(self, url, header=None, request_body=None):
        header = header if header else {}
        request_body = request_body if request_body else {}
        response = request.request("DELETE", url, headers=headers, data=request_body)
